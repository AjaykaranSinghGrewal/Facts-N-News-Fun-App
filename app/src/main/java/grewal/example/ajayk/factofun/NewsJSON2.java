...
public class NewsJSON2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_json2);
        ...
        String newsUrl = "https://newsapi.org/v1/articles?source=techradar&apiKey=923cec3787c64da2b93a9ac3fba2b2cb";
    ...
    private void updateDisplay() {
        ListAdapter adapter = new SimpleAdapter(NewsJSON2.this, newsList, R.layout.news_list, new String[]{"title", "description", "publishedAt"}, new int[]{R.id.newsheading, R.id.newsdescription, R.id.publishedTextView});
        mListView.setAdapter(adapter);

        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                AlertDialogWeb2 dialog = new AlertDialogWeb2();
