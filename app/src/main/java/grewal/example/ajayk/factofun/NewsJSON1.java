...
public class NewsJSON1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String newsUrl = "https://newsapi.org/v1/articles?source=bbc-news&apiKey=923cec3787c64da2b93a9ac3fba2b2cb";
    ...
    private void updateDisplay() {
        ListAdapter adapter = new SimpleAdapter(NewsJSON1.this, newsList, R.layout.news_list, new String[]{"title", "description", "publishedAt"}, new int[]{R.id.newsheading, R.id.newsdescription, R.id.publishedTextView});
        mListView.setAdapter(adapter);

        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                AlertDialogWeb1 dialog = new AlertDialogWeb1();
