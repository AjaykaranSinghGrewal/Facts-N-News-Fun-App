...
public class NewsJSON4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String newsUrl = "https://newsapi.org/v1/articles?source=metro&apiKey=923cec3787c64da2b93a9ac3fba2b2cb";
    ...
    private void updateDisplay() {
        ListAdapter adapter = new SimpleAdapter(NewsJSON4.this, newsList, R.layout.news_list, new String[]{"title", "description", "publishedAt"}, new int[]{R.id.newsheading, R.id.newsdescription, R.id.publishedTextView});
        mListView.setAdapter(adapter);

        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                AlertDialogWeb4 dialog = new AlertDialogWeb4();
